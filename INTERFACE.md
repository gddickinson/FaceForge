...
| `ground_contact.py` | Keep the feet (or hands) on the floor while the joints move; hands anchored to a point (a bar) are measured at the closed-finger ring. The foot target is lowered by `sole_clearance` -- how far the body's lowest point rests above the floor -- because an ankle pivot is inside the ankle, and holding *it* at its standing height left the body clear of the floor. |
